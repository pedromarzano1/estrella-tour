      ...
      <section className="relative bg-gradient-to-br from-slate-950 via-slate-900 to-brand-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-[#3d8040]/20 border border-[#3d8040]/40 text-[#3d8040] px-4 py-1.5 rounded-full text-sm font-medium mb-6">
              <Star className="w-4 h-4 fill-[#3d8040] text-[#3d8040]" />
              Más de 16 años de confianza
            </div>
            <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">
              Viajá con
              <span className="text-[#3d8040]"> Estrella Tour</span>
            </h1>
